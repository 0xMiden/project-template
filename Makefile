...
help:
	...
	@echo 
	@echo "Prerequisites:"
	@echo "\033[36mcargo install taplo-cli --locked\033[0m"
	@echo "\033[36mcargo install mdbook --locked\033[0m"
	@echo "\033[36mcargo install mdbook-linkcheck --locked\033[0m"
	@echo "\033[36mcargo install mdbook-katex --locked\033[0m"
	@echo "\033[36mcargo install mdbook-alerts --locked\033[0m"
	@echo "\033[36mcargo install cargo-nextest --locked\033[0m"
	@echo "\033[36mcargo install typos-cli --locked\033[0m"
